      ...
      {showUnsavedWarning && (
        ...
        >
          <div className="bg-white rounded-lg p-6 max-w-md mx-4 shadow-xl">
            ...
            <p className="text-gray-600 mb-6">
              You have unsaved changes. Save before <span className="font-semibold" style={{ color: 'var(--secondary-teal)' }}>{pendingAction === 'generate' ? 'generating markdown' : 'navigating away'}</span>?
            </p>
            <div className="flex gap-3 justify-end">
              <Button
                variant="outline"
